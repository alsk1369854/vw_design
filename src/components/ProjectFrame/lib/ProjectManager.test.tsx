...
import incomplete2_JSON from './TestData/vw_projects/incomplete2.json'
import other_JSON from './TestData/vw_projects/other.json'
import project_1_JSON from './TestData/vw_projects/project_1.json'
import test_JSON from './TestData/vw_projects/test.json'
